...
public class BankingSystem {
	public static void main(String[] args) {
		...
		Thread t2 = new Thread(new Transaction(account, "Customer-2", 4000), "Customer-1");
		Thread t3 = new Thread(new Transaction(account, "Customer-3", 2000), "Customer-1");
		Thread t4 = new Thread(new Transaction(account, "Customer-4", 5000), "Customer-1");
		Thread t5 = new Thread(new Transaction(account, "Customer-5", 1500), "Customer-1");
